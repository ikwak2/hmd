...
#                 fs = 4000.0
            ...
            amplit_smooth = smoothing(amplitude_envelope,70)
...
for i in range(5) :
    model_folder = 'hyper_3_2'
    output_folder = '/Data/hmd/hmd_sy/2021_hmd/tmp/out_hyper_3_2'
    ...
    with open('/Data/hmd/hmd_sy/2021_hmd/mm_lbs_trn_smooth.pkl','rb') as f:
        mm_lbs_trn = pickle.load(f)

    with open('/Data/hmd/hmd_sy/2021_hmd/out_lbs_trn_smooth.pkl','rb') as f:
        out_lbs_trn = pickle.load(f)



    with open('/Data/hmd/hmd_sy/2021_hmd/features_test_smooth.pkl','rb') as f:
        features_test = pickle.load(f)

    with open('/Data/hmd/hmd_sy/2021_hmd/mm_lbs_test_smooth.pkl','rb') as f:
        mm_lbs_test = pickle.load(f)

    with open('/Data/hmd/hmd_sy/2021_hmd/out_lbs_test_smooth.pkl','rb') as f:
